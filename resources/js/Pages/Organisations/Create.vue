...
<div>
	...
	<form @submit.prevent="store">
		<div class="p-8 -mr-6 -mb-8 flex flex-wrap">
			...
			<text-input v-model="form.email" :error="form.errors.email" class="pr-6 pb-8 w-full lg:w-1/2" label="Corporate Email" />

			<text-input v-model="form.phone" :error="form.errors.phone" class="pr-6 pb-8 w-full lg:w-1/2" label="Corporate Phone" />
...
export default {
	metaInfo: { title: 'Create Organisation' },
	...
	methods: {
		store() {
			this.form.post(this.route('organisations.store'))
		},
	},
}
</script>
