<template>
  <div>
    ...
    <!--TO ORGANISATIONS-->
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('organisations')">
        <icon name="office" class="w-4 h-4 mr-2" :class="isUrl('organisations') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('organisations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Organisations</div>
      </inertia-link>
    </div>
    ...
    <!--TO BUSINESSES-->
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3" :href="route('businesses')">
        <icon name="office" class="w-4 h-4 mr-2" :class="isUrl('businesses') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('businesses') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Businesses</div>
      </inertia-link>
    </div>
